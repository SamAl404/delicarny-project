...
<head>
    ...
    <title>Pedido Confirmado | Delicarny</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1">
        <div class="container text-center py-5">
            <h1 class="text-success fw-bold mb-4" style="font-family: 'Poppins', sans-serif;">¡Pedido registrado exitosamente!</h1>
            <p class="lead">Gracias por tu compra. Estamos preparando tu pedido.</p>
            <a href="../menu-page/index.php" class="btn btn-outline-dark mt-3">Volver al menú</a>
        </div>
    </main>
